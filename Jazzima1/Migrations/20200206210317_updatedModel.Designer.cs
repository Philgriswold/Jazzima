...
namespace Jazzima1.Migrations
{
    ...
    [Migration("20200206210317_updatedModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jazzima1.Models.Album", b =>
                {
                    ...
                    b.Property<int?>("MusicianAlbumId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Jazzima1.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e03881e9-79ef-42b4-90be-a8bddcd83072",
                            Email = "admin@admin.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@ADMIN.COM",
                            NormalizedUserName = "ADMIN@ADMIN.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEOIdz3/3yH6Cubh3N/7AVW8R12nFTIASvmE+Ja4bSgWysv50PzXRGlGObILkVrkUEw==",
            ...
            modelBuilder.Entity("Jazzima1.Models.Album", b =>
                {
                    b.HasOne("Jazzima1.Models.MusicianAlbum", null)
                        .WithMany("Albums")
                        .HasForeignKey("MusicianAlbumId");
                });
