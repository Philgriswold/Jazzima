...
namespace Jazzima1.Controllers
{
    public class MusiciansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Instrument")] Musician musician)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Instrument")] Musician musician)
        {
            if (id != musician.Id)
            {
                return NotFound();
